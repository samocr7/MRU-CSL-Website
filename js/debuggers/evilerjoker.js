$.getJSON("https://na.api.pvp.net/api/lol/na/v1.4/summoner/by-name/evilerjoker?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653",function(data){
    console.log(data);
      var hname = document.getElementById("name");
    var playerName = data.evilerjoker.name;
    hname.innerHTML = (playerName);
    var icon = data.evilerjoker.profileIconId;
    console.log(icon);
...
$.getJSON("https://na.api.pvp.net/api/lol/na/v1.3/game/by-summoner/21527831/recent?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653", function(game){
...
function getRank(){
    $.ajax({
        url:"https://na.api.pvp.net/api/lol/na/v2.5/league/by-summoner/21527831/entry?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653",
        crossDomain:true,
        type: 'GET',
        dataType: 'json',
        data:{},
        success: function(rank){
            var rank = (rank['21527831'][0].tier);
