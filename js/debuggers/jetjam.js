$.getJSON("https://na.api.pvp.net/api/lol/na/v1.4/summoner/by-name/jetjam?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653",function(data){
    console.log(data);
      var hname = document.getElementById("name");
    var playerName = data.jetjam.name;
    hname.innerHTML = (playerName);
    var icon = data.jetjam.profileIconId;
    console.log(icon);
...
$.getJSON("https://na.api.pvp.net/api/lol/na/v1.3/game/by-summoner/20993073/recent?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653", function(game){
...
function getRank(){
    $.ajax({
        url:"https://na.api.pvp.net/api/lol/na/v2.5/league/by-summoner/20993073/entry?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653",
        crossDomain:true,
        type: 'GET',
        dataType: 'json',
        data:{},
        success: function(rank){
            var rank = (rank['20993073'][0].tier);
