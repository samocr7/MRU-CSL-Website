$.getJSON("https://na.api.pvp.net/api/lol/na/v1.4/summoner/by-name/mrspooky?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653",function(data){
    console.log(data);
      var hname = document.getElementById("name");
    var playerName = data.mrspooky.name;
    hname.innerHTML = (playerName);
    var icon = data.mrspooky.profileIconId;
    console.log(icon);
...
$.getJSON("https://na.api.pvp.net/api/lol/na/v1.3/game/by-summoner/48503951/recent?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653", function(game){
...
function getRank(){
    $.ajax({
        url:"https://na.api.pvp.net/api/lol/na/v2.5/league/by-summoner/48503951/entry?api_key=bb84ac28-9890-40ff-9bd1-9331359bf653",
        crossDomain:true,
        type: 'GET',
        dataType: 'json',
        data:{},
        success: function(rank){
            var rank = (rank['48503951'][0].tier);
